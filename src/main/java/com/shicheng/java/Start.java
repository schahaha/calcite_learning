...
public class Start {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
       ...
       Connection connection= DriverManager.getConnection("jdbc:calcite:model=target/classes/day01/excel.json");
        ...
        PreparedStatement preparedStatement = connection.prepareStatement("select c.sex, sum(salary), min(salary)  from  (select a.sex , a.salary from table1 a join table1 b on a.sex=b.sex ) c group by c.sex    ");
